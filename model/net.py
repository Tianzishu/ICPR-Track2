...
class res_UNet_resnet_10_4(nn.Module):
    def __init__(self, num_classes=1, input_channels=3, block=Res_SimAM_block, num_blocks=[1, 1, 1, 1], nb_filter=[4, 8, 16,32, 64]):
        super(res_UNet_resnet_10_4, self).__init__()
...
class DCANet_L(nn.Module):
    def __init__(self, num_classes=1, input_channels=3, block=Res_SimAM_block, num_blocks=[2, 2, 2, 2], nb_filter=[4, 8, 16, 32, 64], deep_supervision=True, mode='test'):
