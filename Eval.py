...
Fa = 1.11800300e-05 #虚警率 False alarm rate
Pd = 0.54687   #检测率 Detection rate
IoU = 0.6146549077163337  #平均交并比 average intersection over union
Params = 0.402021 #模型参数量 M Parameters of your model (Unit: M)
Flops = 1.664451 #模型运算量 GFlops of your model
